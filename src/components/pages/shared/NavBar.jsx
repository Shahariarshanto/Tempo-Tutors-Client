...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="/" className="flex items-center">
      ...
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Tempo Tutors</span>
  </a>
  <div className="flex items-center gap-4 md:order-2">
  <button onClick={toggleDarkMode}> {darkMode ? <FiSun className="w-6 h-6 dark:text-gray-200" /> : <FiMoon className="w-6 h-6 dark:text-gray-200" />}</button>
